            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::model($entrevistaViewModel, array('route' => ['entrevista',$entrevistaViewModel->idProcesoAdmision], 'method' => 'post', 'class' => 'form-horizontal') ) }}
						...
						<br/>
						La información que nos suministre es importante y tendrá un uso confidencial.
						<br/>
						<br/>
						...
						<br/>
						Acepto recibir información de la (CUI) a través de mensaje de texto, correo electrónico o llamadas telefónicas.
						<br/>
						<br/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
							  {{ Form::radio('aceptaComunicacion', '1', null) }} Acepto <br/>
							  {{ Form::radio('aceptaComunicacion', '0', null) }} No acepto  <br/>
							</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
							  ...
							  {{ Form::radio('aceptaPoliticasPriv', '0', null) }} No acepto  <br/>
							</div>
                        </div>
...
<!-- Cuestionario de admisión ----------------------------------------------------------------------  -->
					...
					<br/>
					<br/>
					En este cuestionario le presentamos una serie de preguntas relacionadas con sus intereses, motivaciones, hábitos y técnicas de estudio entre otros aspectos. 
					<br/>
					<br/>
					Aquí debe elegir solo una de las opciones que se presentan
					<br/>
					<br/>
					...
					<br/>
					<br/>
					Aquí debe elegir solo una de las opciones que se presentan: Siempre, Casi siempre, a menudo, Rara vez, Nunca
					<br/>
					<br/>
...
<br/>
<br/>
El resultado del proceso de admisión a la Corporación Universitaria Iberoamericana le será notificado dos (2) días hábiles después de la responder al cuestionario y a la entrega de los documentos de admisión establecidos en el Reglamento Estudiantil. El contacto se realizará tanto telefónicamente como por correo electrónico a los datos de contacto suministrados en el formulario de inscripción.
<br/>
<br/>
...
<br/>
●	Programación de segunda entrevista.
<br/>
●	Concepto de no admitido (La CUI se reserva el derecho de admisión).
<br/>
<br/>
